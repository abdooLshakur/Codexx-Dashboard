...
const CreateProduct = () => {
  ...
  const handleEvent = (e) => {
    ...
    formData.append("currrency", productcurrency);
    ...
    <div className="max-w-4xl mx-auto mt-10 bg-white shadow-lg rounded-lg p-8">
      ...
      <form onSubmit={handleEvent} className="grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <select value={categoryid} onChange={(e) => setCategoryid(e.target.value)} className="w-full p-3 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300">
