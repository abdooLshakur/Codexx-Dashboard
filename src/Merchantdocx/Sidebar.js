    ...
    <div className="w-64 bg-white shadow-md h-full">
      ...
      <nav className="mt-6">
        <ul className="space-y-4">
          <li>
            <Link to="/create-product" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200">
              <FaBox className="text-lg" /> Products
            </Link>
          </li>
          <li>
            <Link to="/categories" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200">
              <FaTags className="text-lg" /> Categories
            </Link>
          </li>
          <li>
            <Link to="/banners" className="flex items-center gap-2 p-2 text-gray-700 hover:bg-gray-200">
